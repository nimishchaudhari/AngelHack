...
echo " ";
  ...
  <form action='<?php echo $paypal_url; ?>' method='post' name='frmPayPal1'>
                    ...
                    <input type='hidden' name='cmd' value='_xclick'>
                     ...
                     <input name='amount' value='' placeholder="Donation Amount"><br>
...
<br>
                   <input type="submit" name="submit"  class="btn btn-primary" style="text-decoration: none;" value="Donate To <?php echo  ucfirst($collect_data['name']);?>" ></input>
