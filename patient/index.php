            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-ination">
                    <tbody>
                      <tr>
                        <td>Disease:</td>
...
<TR>
   ...
   echo '<form action = "fileu.php" method = "POST" enctype = "multipart/form-data">
         <input type = "file" name = "image" />
         <input type="text" style="display:none;" name="id" value="'.$_SESSION['id'].'">
         <input type = "submit"/>
         ';
     }
         }
