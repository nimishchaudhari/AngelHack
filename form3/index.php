...
<div class="form-group">
 ...
 <div class="form-group">
  <label class="col-md-4 control-label">Disease</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="disease" placeholder="Disease" class="form-control input-lg"  type="text">
    </div>
  </div>
</div>
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Age</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="age" placeholder="Age" class="form-control input-lg"  type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  ...
  <input name="doctor" placeholder="Doctor" class="form-control input-lg" type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Fund #</label>  
    <div class="col-md-5 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="fund" placeholder="Amount" class="form-control input-lg" type="text">
    </div>
  </div>
</div>
<!-- Text input-->
...
<!-- radio checks -->
 <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="severity" value="1" /> High
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="severity" value="0" /> Low
                                </label>
                            </div>
                        </div>
                    </div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12 animate-box">
						<div class="vblr-footer-widget">
							...
							<ul class="vblr-links">
								...
								<li><a href="donors" target="_blank">Donor's Portal</a></li>
							</ul>
						</div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 animate-box">
