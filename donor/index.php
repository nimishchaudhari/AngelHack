...
input {
  ...
  <script src="http://s.codepen.io/assets/libs/modernizr.js" type="text/javascript"></script>
	...
	<div id="vblr-page">
		<section id="vblr-header" >
			<div class="container">
				<nav role="navigation" >
					<h1 id="vblr-logo"><a href="../index.php"><img src="../images/v-logo.png" style="float:left;" /><span></span></a></h1>
				</nav>
			</div>
		</section>
		<!-- END #vblr-header -->
 ...
 <form class=" form-horizontal" action="login_check.php" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button type="submit" class="upload-btn" style="background-color: #00ACBC;padding: 10px 25px;width: 470px;font-size: 15px;text-overflow: ellipsis;white-space: nowrap;" >Login  <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
