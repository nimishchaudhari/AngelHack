			...
			<div class="container">
				<div class="row text-center row-bottom-padded-md">
					<div class="col-md-8 col-md-offset-2">
						...
						<p class="animate-box"><a href="patients"  class="btn btn-green" style="background-color: #83c983;"><span class="artist"><i class=""></i>&nbsp;&nbsp;</span>Child
							</span></a> <a href="donors" class="btn btn-green"  style="background-color: #83c983;><span class="visiter"><i class=""></i>&nbsp;&nbsp;</span>Women</a></p>
					</div>
				</div>
				<div class="row">
